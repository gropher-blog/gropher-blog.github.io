...
<div id="leftcontent">
	...
	<div class="post">
		...
		if (!$send) { ?>
			...
			<p class="cat">
				Created on <?php the_time('j-M-y'); ?> <?php edit_post_link(); ?>
			</p>
			<div class="postcontent">
				<?php the_content("Continue Reading &#187;");
				?>
				<p class="cat">* - Required Fields</p>
				<?php echo $error_msg;?>
				<form method="post" action="<?php echo "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" id="contactform">
					...
					<input type="text" class="textbox" id="cp_ans" name="cp_ans" value="<?php echo $cp_ans ;?>" /><p class="cat">[Just to prove you are not a spammer]</p><br/>
